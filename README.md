...
RepFeed is a project of Node.js and JavaScript which presents an Chrome Extension that allows the user to control the political tweets to which he wants to be exposed in his feed and allows the user to see tweets of a particular population segment by selecting filters.<br>
